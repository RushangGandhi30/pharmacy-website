              ...
              {categoriesList.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-start p-6 bg-white border border-gray-200/80 rounded-2xl shadow-sm text-left hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group relative overflow-hidden`}
                  >
                    {/* Corner accent decorative box */}
                    <div className="absolute top-0 right-0 w-24 h-24 bg-gray-50 rounded-bl-full -z-10 transition-colors group-hover:bg-teal-50/20" />
                    ...
                    <h3 className="font-extrabold text-gray-900 text-lg mb-2 group-hover:text-teal-600 transition-colors">
                    ...
                    <div className="flex items-center justify-between w-full border-t border-gray-100 pt-4 text-xs font-bold text-teal-600 uppercase tracking-wider group-hover:text-teal-700">
                      <span>Explore Catalog</span>
                      <span className="bg-teal-50 text-teal-700 py-0.5 px-2.5 rounded-full text-[10px]">
                        {count} Items
                      </span>
                    </div>
                  </button>
